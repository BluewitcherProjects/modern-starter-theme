<!-- Newsletter Section -->
@if(theme_setting('show_newsletter', true))
<section class="bg-primary-500 py-12">
    <div class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="text-primary-100 mb-6">Get the latest updates on new products and upcoming sales</p>
            <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input type="email" placeholder="Enter your email" class="flex-1 px-4 py-3 rounded-lg focus:ring-2 focus:ring-white focus:outline-none">
                <button type="submit" class="px-6 py-3 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors">Subscribe</button>
            </form>
        </div>
    </div>
</section>
...
<footer class="bg-gray-900 text-gray-300">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-{{ theme_setting('footer_columns', '4') }} gap-8">
            <!-- About -->
            <div>
                <h4 class="text-lg font-bold text-white mb-4">{{ config('app.name', 'Store') }}</h4>
                <p class="text-gray-400 mb-4">Your one-stop shop for quality products at great prices. We deliver happiness to your doorstep.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/new-arrivals" class="text-gray-400 hover:text-white transition-colors">New Arrivals</a></li>
                    <li><a href="/bestsellers" class="text-gray-400 hover:text-white transition-colors">Best Sellers</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/returns" class="text-gray-400 hover:text-white transition-colors">Returns & Exchanges</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-400">123 Store Street, City, Country 12345</span>
                    </li>
                    ...
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-400">support@store.com</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="border-t border-gray-800 py-6">
        <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">&copy; {{ date('Y') }} {{ config('app.name', 'Store') }}. All rights reserved.</p>
